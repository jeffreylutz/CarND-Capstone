...
class Controller(object):
    def __init__(self, *args, **kwargs):
        ...
        self.steering_cntrl = YawController(self.wheel_base, self.steer_ratio, MIN_SPEED, self.max_lat_accel,
    ...
    def control(self, *args, **kwargs):
        ...
        if dbw_enabled:
            ...
            #steering_val = self.steering_cntrl.get_steering(twist_cmd.twist.linear.x, twist_cmd.twist.angular.z,
